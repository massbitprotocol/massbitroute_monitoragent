...
if sys.version_info[0] == 2:
    ...
    from urllib2 import Request, urlopen  # pylint: disable=import-error,no-name-in-module
    from urllib2 import URLError, HTTPError  # pylint: disable=import-error,no-name-in-module
...
def urlopen_with_ssl(request, timeout):
    ...
    if (sys.version_info[0] == 3 and sys.version_info >= (3, 5)) or \
        ...
        if sys.version_info[0] == 2:
            ...
            from urllib2 import HTTPSHandler, build_opener, install_opener  # pylint: disable=import-error,no-name-in-module
